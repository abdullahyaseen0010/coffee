  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 md:px-6">
      <div className="rounded-[32px] border border-[#2d1b12]/10 bg-white/70 p-8 text-center shadow-[0_18px_45px_rgba(71,47,26,0.04)]">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-[-0.06em] text-on-dark">Thanks for your order</h1>
        <p className="mt-4 text-base text-muted-on-light">Your order reference is <span className="font-semibold text-on-light">VRO-1042</span>. A receipt has been sent to your inbox.</p>
      </div>

      <div className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-[28px] border border-[#2d1b12]/10 bg-white/70 p-6">
          <h2 className="text-xl font-bold text-on-light">Order details</h2>
          <div className="mt-5 space-y-3 text-sm text-muted-on-light">
        ...
        <div className="rounded-[28px] border border-[#2d1b12]/10 bg-white/70 p-6">
          <h2 className="text-xl font-bold text-on-light">Status</h2>
          ...
          <p className="mt-4 text-sm text-muted-on-light">Your coffee is being prepared and will ship within 48 hours.</p>
        </div>
      </div>

      <div className="mt-8 flex justify-center">
        <Link href="/shop" className="rounded-full bg-[#2d1b12] px-6 py-3 text-sm font-semibold text-on-dark">
          Continue shopping
        </Link>
      </div>
    </div>
