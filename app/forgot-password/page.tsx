  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16 md:px-6">
      <div className="rounded-[30px] border border-[#2d1b12]/10 bg-white/70 p-7 shadow-[0_18px_45px_rgba(71,47,26,0.04)]">
        ...
        <h1 className="mt-2 text-3xl font-black tracking-[-0.06em] text-on-dark">Forgot password?</h1>
        ...
        <form className="mt-6 space-y-4">
          ...
          <button type="submit" className="w-full rounded-full bg-[#2d1b12] px-5 py-3 text-sm font-semibold text-on-dark">Send reset link</button>
        </form>
